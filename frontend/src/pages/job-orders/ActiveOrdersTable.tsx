...
export default function ActiveOrdersTable({ setPresetData, reloadFlag, setShowModal, selectedId, setSelectedId, setSelectedJobOrder, setInvalidateData, setLastUpdated }: ActiveOrdersTableProps) {
    ...
    const handleEdit = async (item: any) => {
        ...
        setPresetData({
            ...
            materials: jobOrder.materials.map((mat: Material) => ({ id: mat.id, materialName: mat.materialName, quantity: mat.quantity, price: mat.price! / 100, selling: mat.selling! / 100 })), remarks: "", branchId: item.branchId
        } as FormData)
        setShowModal('edit');
    }
