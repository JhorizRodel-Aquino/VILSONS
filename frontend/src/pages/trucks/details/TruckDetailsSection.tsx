...
// { data, reload }: { data: Record<string, any>, reload: () => void }
export default function TruckDetailsSection() {
    ...
    const handleEdit = async () => {
        setPresetData({ plate, make, model } as FormData)
        setShowModal('edit');
    }
                ...
                <div className="grid gap-[20px] content-start overflow-y-auto thin-scrollbar">
                    ...
                    <section className="card w-full">
                        <div className="flex justify-between items-center  mb-5">
                            ...
                            <Button label="Change" variant="outline" size="mini" onClick={() => setShowModal("owner")} />
                        </div>
